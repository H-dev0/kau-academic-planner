...
if len(supported) != 182:
    raise AssertionError(f"expected 182 supported programs, got {len(supported)}")
...
print("Staged smoke: homepage 200; registry 200; 182 details and 182 plans passed")
